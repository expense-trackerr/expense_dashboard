...
export type GetTransactionsQuery = { __typename?: 'Query', getTransactions: Array<{ __typename?: 'Transaction', amount: string, currency: string, date: string, id: string, name: string, pending: boolean, category?: { __typename?: 'CategoryName', name: string } | null, linked_sub_account: { __typename?: 'LinkedSubAccount', account_id: string, name: string, alias_name?: string | null } }> };
